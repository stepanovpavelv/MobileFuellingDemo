...
namespace MobileFueling.DB
{
    public static class FuelMobileBuilder
    {
        public static void OnModelCreating(ModelBuilder builder)
        {
            ...
            // fuel prices
            builder.Entity<FuelPrice>().ToTable("FuelPrices");
            builder.Entity<FuelPrice>().HasKey(x => x.Id);
            builder.Entity<FuelPrice>().HasOne(x => x.FuelType).WithMany().HasForeignKey(x => x.FuelTypeId);
            builder.Entity<FuelPrice>().Property(x => x.Price).HasColumnType("decimal(8,2)");
            ...
            builder.Entity<ClientOrderDetalization>().Property(x => x.FuelPrice).HasColumnType("decimal(8,2)");
            builder.Entity<ClientOrderDetalization>().Property(x => x.Cost).HasColumnType("decimal(11,2)");
